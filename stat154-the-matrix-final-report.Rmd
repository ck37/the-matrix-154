...
author: 'The Matrix (team 5): Zhenzheng Hu, Chris Kennedy, Dan (Dong Kyun) Kim, Stephanie
  Kim, SaeJin Kim'
output: html_document
---

## <span style="color:aquamarine">1. Description</span>
...
## <span style="color:aquamarine">2. Feature Creation</span>
...
## <span style="color:aquamarine">3. Unsupervised Feature Filtering</span>

################ need to add the histogram here WITH Explanations



## <span style="color:aquamarine">4. Classification of Word Feature Matrix</span>
...
## <span style="color:aquamarine">5. Classification of Power Word Feature Matrix</span>
...
## <span style="color:aquamarine">6. Classification of Combined Feature Matrix</span>

## <span style="color:darkorange">7. Final Model</span>
